...
cmd:text('Options')
-- data
cmd:option('-train_file','../data/train.tsv','training set file location')
cmd:option('-dev_file','../data/dev.tsv','dev set file location')
cmd:option('-test_file','../data/test.tsv','test set file location')
cmd:option('-res_file','../data/result.tsv','result file location')
